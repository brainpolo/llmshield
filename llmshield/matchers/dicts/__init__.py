...
Description:
    This subpackage contains text files with known entities used for
    dictionary-based entity detection. These files include lists of cities,
    countries, organisations, and common English words used to improve
